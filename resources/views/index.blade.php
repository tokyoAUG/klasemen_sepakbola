...
@stop
@section('content')
<div class="hero overlay" style="background-image: url('{{ asset('template/images/bg_3.jpg')}}');">
      <div class="container">
          ...
          <div class="d-flex team-vs">
            ...
            <div class="team-1 w-50">
              <div class="team-details w-100 text-center">
                <img src="{{ asset('template/images/logo_1.png')}}" alt="Image" class="img-fluid">
            ...
            <div class="team-2 w-50">
              <div class="team-details w-100 text-center">
                <img src="{{ asset('template/images/logo_2.png')}}" alt="Image" class="img-fluid">
                ...
                <div class="caption-inner">
                  ...
                  <div class="author d-flex align-items-center">
                    <div class="img mb-2 mr-3">
                      <img src="{{ asset('template/images/person_1.jpg')}}" alt="">
                    </div>
                    <div class="text">
